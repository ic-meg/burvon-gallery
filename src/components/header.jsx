        ...
        >
          ...
          <div className="w-full px-6 pb-6">
            ...
            <button
              ...
              className="flex items-center justify-between text-[1rem] bg-transparent border-none cursor-pointer w-full"
            >
      ...
      >
        ...
        <nav className="flex-1 flex justify-end items-center space-x-8 -mt-8 avant uppercase cream-text text-[1.26rem]">
          <button 
            ...
            className="hover:opacity-60 bg-transparent border-none cursor-pointer"
          >
            Necklaces
          </button>
          <button 
