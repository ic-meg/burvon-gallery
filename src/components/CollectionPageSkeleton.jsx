...
const CollectionPageSkeleton = () => {
  ...
  return (
    <>
      ...
      {/* Collection Section: Filters Skeleton */}
      <section className="bg-[#1f1f21] text-[#FFF7DC] pt-8 pb-10 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-6">
          {/* Collection Title Skeleton */}
          <div className="h-16 w-48 bg-[#2a2a2a] rounded flex-shrink-0" style={shimmerStyle}></div>
      ...
      {/* Collection Highlights Section Skeleton */}
