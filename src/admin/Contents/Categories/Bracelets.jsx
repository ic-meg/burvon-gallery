...
const Bracelets = () => {
  const [braceletsImages, setBraceletsImages] = useState([null, null, null, null, null, null, null, null]);
  ...
  // Handle bracelets carousel image upload
  const handleBraceletsImageUpload = (index, e) => {
    const file = e.target.files[0];
    if (file) {
      const newBraceletsImages = [...braceletsImages];
      newBraceletsImages[index] = file;
      setBraceletsImages(newBraceletsImages);
    }
  };

  // Handle bracelets image removal
  ...
  const handleSaveChanges = () => {
    console.log('Saving bracelets changes...');
    // Add your save logic here
  };

  // Preview handler
  const handlePreview = () => {
    console.log('Opening bracelets preview...');
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-4">
            <div className="grid grid-cols-4 grid-rows-2 gap-2">
              {braceletsImages.map((image, index) => (
