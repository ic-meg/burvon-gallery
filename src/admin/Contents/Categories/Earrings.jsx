...
const Earrings = () => {
  const [earringsImages, setEarringsImages] = useState([null, null, null, null, null, null, null, null]);
  ...
  // Handle earrings carousel image upload
  const handleEarringsImageUpload = (index, e) => {
    const file = e.target.files[0];
    if (file) {
      const newEarringsImages = [...earringsImages];
      newEarringsImages[index] = file;
      setEarringsImages(newEarringsImages);
    }
  };

  // Handle earrings image removal
  ...
  const handleSaveChanges = () => {
    console.log('Saving earrings changes...');
    // Add your save logic here
  };

  // Preview handler
  const handlePreview = () => {
    console.log('Opening earrings preview...');
    ...
    <div className="grid grid-cols-2 gap-8 -mt-8 h-full">
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <h2 className="text-left text-5xl bebas text-black">EARRINGS CAROUSEL</h2>
          <div className="flex items-start space-x-4">
            <div className="grid grid-cols-4 grid-rows-2 gap-2">
              {earringsImages.map((image, index) => (
