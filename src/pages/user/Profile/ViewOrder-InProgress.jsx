      ...
      <div className="flex flex-row px-12 py-8 gap-12 relative">
        ...
        <div className="absolute top-9 right-0 flex flex-col gap-2 avant cream-text text-md min-w-[460px] items-end pr-12">
          ...
          <div className="flex gap-2 self-end mt-2">
            <button className="avantbold rounded border border-[#FFF7DC] cream-text px-4 py-2 text-md">CANCEL ORDER</button>
            <button className="avantbold cream-bg metallic-text px-4 py-2 rounded text-md">TRACK ORDER</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="md:hidden w-full min-h-screen bg-[#181818] text-[#fff7dc] px-2 pt-4">
      ...
      <div className="flex flex-col gap-4 py-6">
        ...
        <div className="flex flex-col items-end w-full max-w-[340px] pt-8">
          ...
          <div className="flex gap-2 self-end mt-2">
            <button className="avantbold rounded border border-[#FFF7DC] cream-text px-3 py-2 text-xs">CANCEL ORDER</button>
            <button className="avantbold cream-bg metallic-text px-3 py-2 rounded text-xs">TRACK ORDER</button>
          </div>
        </div>
      </div>
    </div>
