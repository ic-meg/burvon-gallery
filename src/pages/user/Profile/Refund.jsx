                      ...
                      <div className="flex flex-col gap-1 ml-45 mt-[-40px] mr-12">
                        <div className="flex gap-20"> {/* gap between order date and expected delivery */}
                          <div>
                            ...
                            <div className="avant cream-text text-lg">₱ {item.price.toFixed(2)}</div>
                          </div>
                          <div>
              ...
              <div className="flex-1">
                ...
                {showSubtotal && (
                  <div className="flex justify-end mt-2">
                    ...
                    <span className="avantbold text-nowrap cream-text text-xs ml-2">₱ {selectedOrder.subtotal.toLocaleString(undefined, {minimumFractionDigits:2})}</span>
                  </div>
                )}
              </div>
            </div>
