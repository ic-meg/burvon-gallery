...
import jewelrycareBG1 from '../../assets/images/jewelrycareBG1.png';
...
const carouselData = [
  {
    ...
    text: (
      <>
        Dip a <span style={{ fontWeight: 700 }}>soft cloth</span> or <span style={{ fontWeight: 700 }}>microfiber cloth</span> in <span style={{ fontWeight: 700 }}>warm water</span> and <span style={{ fontWeight: 700 }}>gentle soap</span> combination. Use this to clean your jewelry. Make sure to clean <span style={{ fontWeight: 700 }}>all</span> sides.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        To rinse off, use <span style={{ fontWeight: 700 }}>soft cloth</span> or <span style={{ fontWeight: 700 }}>microfiber cloth</span> dipped in clean water. Wipe off any soap residue until jewelry is polished.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <span style={{ fontWeight: 700 }}>Dry</span> jewelry with <span style={{ fontWeight: 700 }}>soft cloth</span> or <span style={{ fontWeight: 700 }}>microfiber cloth</span> and <span style={{ fontWeight: 700 }}>leave</span> to <span style={{ fontWeight: 700 }}>air dry</span> on a <span style={{ fontWeight: 700 }}>cool dry place.</span>
      </>
    ),
  },
];
...
const JewelryCare = () => {
  ...
  const handlePrev = () => setCurrent((prev) => (prev === 0 ? carouselData.length - 1 : prev - 1));
  const handleNext = () => setCurrent((prev) => (prev === carouselData.length - 1 ? 0 : prev + 1));
    ...
    <Layout full>
      ...
      <div className="block md:hidden min-h-screen bg-[#181818] flex flex-col">
        ...
        <div className="w-full h-[440px] relative overflow-hidden">
          ...
          {/* title*/}
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-[#FFF7DC] px-6" style={{ zIndex: 2 }}>
            <h1 className="font-bold bebas" style={{ fontSize: '2.7rem', marginBottom: '0.5rem' }}>
              JEWELRY CARE
            </h1>
            <p className="avant" style={{ fontSize: '0.80rem', marginTop: '-0.7rem' }}>
        ...
        <div className="flex flex-col items-center justify-center px-10 py-7">
          ...
          >
            ...
            <div className="flex flex-row items-center justify-center mb-4 mt-2">
              <img src={carouselData[current].icon} alt={carouselData[current].title} className="h-8 w-8" />
            </div>
            <h3
            ...
            <p className="avant-book text-center leading-relaxed text-[#FFF7DC] mb-2" style={{ fontSize: '1rem' }}>
              {current === 0 && (
                <>
                  Dip a <span style={{ fontWeight: 700 }}>soft cloth</span> or <span style={{ fontWeight: 700 }}>microfiber cloth</span> in <span style={{ fontWeight: 700 }}>warm water</span> and <span style={{ fontWeight: 700 }}>gentle soap</span> combination. Use this to clean your jewelry. Make sure to clean <span style={{ fontWeight: 700 }}>all</span> sides.
                </>
              ...
              {current === 1 && (
                <>
                  To rinse off, use <span style={{ fontWeight: 700 }}>soft cloth</span> or <span style={{ fontWeight: 700 }}>microfiber cloth</span> dipped in clean water. Wipe off any soap residue until jewelry is <span style={{ fontWeight: 700 }}>polished</span>.
                </>
              )}
              {current === 2 && (
                <>
              ...
              {carouselData.map((_, idx) => (
                <span
                  ...
                  className={`h-3 w-3 rounded-full flex items-center justify-center ${
                    current === idx
                      ? 'bg-[#FFF7DC]'
                      : 'bg-transparent border border-[#FFF7DC]'
                  }`}
                  style={{
        ...
        <div className="block md:hidden w-full">
          ...
          >
            <h3 className="avant-demi text-[#FFF7DC] text-2xl font-bold mb-6 text-center tracking-wide">DO</h3>
            <ul className="w-full max-w-md flex flex-col gap-6 ml-10">
              <li className="flex items-center">
                <img src={checkIcon} alt="Check" className="h-6 w-6 mr-4" />
                <span className="avant text-[#FFF7DC] text-sm">Store jewelry in a clean, dry box.</span>
              </li>
              <li className="flex items-center">
                <img src={checkIcon} alt="Check" className="h-6 w-6 mr-4" />
                <span className="avant-book text-[#FFF7DC] text-sm">Hang necklaces to prevent tangling.</span>
              </li>
              <li className="flex items-center">
                <img src={checkIcon} alt="Check" className="h-6 w-6 mr-4" />
                <span className="avant-book text-[#FFF7DC] text-sm">Clean your pieces regularly with a soft cloth.</span>
              </li>
              <li className="flex items-center">
                <img src={checkIcon} alt="Check" className="h-6 w-6 mr-4" />
                <span className="avant-book text-[#FFF7DC] text-sm">Use individual pouches for each item.</span>
              </li>
            </ul>
          </div>
        ...
        <div className="w-full bg-[#181818] py-8 px-6 flex flex-col items-center">
          <h3 className="avant-demi text-[#FFF7DC] text-2xl font-bold mb-6 text-center tracking-wide">DON'T</h3>
          <ul className="w-full max-w-md flex flex-col gap-6 ml-10">
            <li className="flex items-center">
              <img src={xIcon} alt="X" className="h-6 w-6 mr-4" />
              <span className="avant-book text-[#FFF7DC] text-sm">Leave jewelry in humid or wet places.</span>
            </li>
            <li className="flex items-center">
              <img src={xIcon} alt="X" className="h-6 w-6 mr-4" />
              <span className="avant-book text-[#FFF7DC] text-sm">Toss them together in a pouch or drawer.</span>
            </li>
            <li className="flex items-center">
              <img src={xIcon} alt="X" className="h-6 w-6 mr-4" />
              <span className="avant-book text-[#FFF7DC] text-sm">Use harsh chemicals or rough brushes.</span>
            </li>
            <li className="flex items-center">
              <img src={xIcon} alt="X" className="h-6 w-6 mr-4" />
              <span className="avant-book text-[#FFF7DC] text-sm">Mix different pieces together.</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="hidden md:flex flex-col min-h-screen overflow-hidden">
        ...
        >
          ...
          >
            ...
            <p className="avant"
              style={{ top: '50%', transform: 'translateY(-30%)', fontSize: '1.25rem' }}
            >
              Even rebels know how to treat their treasures right.
            </p>
          </div>
